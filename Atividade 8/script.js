const pessoas = 45;
let idade, sexo, opniao = 0, cont = 0;
let mediaIdade = 0 ,maisVelha = 0,maisNova = 99999,qtdPes = 0, porcenBomOti = 0, numHom = 0,numMul = 0;
...
document.write(`
    Média idade: ${parseFloat(mediaIdade).toFixed(2)}<br>
    Mais velha: ${maisVelha}<br>
    Mais nova: ${maisNova}<br>
    Qtd Péssimo: ${qtdPes}<br>
    Ótimo ou bom: ${parseFloat(porcenBomOti).toFixed(0)}%<br>
    Homens: ${numHom}<br>
    Mulheres: ${numMul}
`);
